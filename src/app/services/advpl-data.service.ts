...
export class AdvplDataService {
    ...
    private functions: AdvPLFunction[] = [
        ...
        // Novos Batches de Funções (1-40)
        { name: 'MsDialog', category: 'Interface', description: 'Cria uma janela de diálogo personalizada', syntax: 'MsDialog():New(nTop, nLeft, nBottom, nRight, cCaption)', parameters: ['nTop, nLeft, nBottom, nRight: Coordenadas', 'cCaption: Título'], returnType: 'Object', example: 'oDlg := MsDialog():New(0,0,200,400,"Teste")\noDlg:Activate()', tlppCompatible: true, related: ['TPanel', 'TButton'] },
        { name: 'TPanel', category: 'Interface', description: 'Cria um painel de agrupamento de objetos', syntax: 'TPanel():New(nTop, nLeft, cText, oWnd)', parameters: ['oWnd: Objeto pai'], returnType: 'Object', example: 'oPanel := TPanel():New(0,0,"",oDlg)', tlppCompatible: true },
        { name: 'TButton', category: 'Interface', description: 'Cria um botão na interface', syntax: 'TButton():New(nTop, nLeft, cCaption, oWnd, bAction)', parameters: ['cCaption: Texto', 'bAction: Bloco de execução'], returnType: 'Object', example: 'TButton():New(10,10,"OK",oDlg,{|| oDlg:End()})', tlppCompatible: true },
        { name: 'TGet', category: 'Interface', description: 'Cria um campo de entrada de dados', syntax: 'TGet():New(nTop, nLeft, bSetGet, oWnd, nWidth, nHeight)', parameters: ['bSetGet: Bloco com a variável'], returnType: 'Object', example: 'TGet():New(10,10,{|u| if(u==nil,cVar,cVar:=u)},oDlg,100,12)', tlppCompatible: true },
        { name: 'TSay', category: 'Interface', description: 'Exibe um texto estático na tela', syntax: 'TSay():New(nTop, nLeft, bText, oWnd)', parameters: ['bText: Bloco com o texto'], returnType: 'Object', example: 'TSay():New(10,10,{|| "Nome:"},oDlg)', tlppCompatible: true },
        { name: 'TCQuery', category: 'SQL', description: 'Executa uma query SQL e retorna um alias temporário', syntax: 'TCQuery(cQuery, nWorkArea, cAlias)', parameters: ['cQuery: Comando SQL SELECT'], returnType: 'Nil', example: 'TCQuery "SELECT * FROM SA1" ALIAS "TMP"', tlppCompatible: true, related: ['TCSqlExec'] },
        { name: 'TCSqlExec', category: 'SQL', description: 'Executa comandos SQL (DML) sem retorno', syntax: 'TCSqlExec(cQuery)', parameters: ['cQuery: INSERT, UPDATE ou DELETE'], returnType: 'Numeric', example: 'TCSqlExec("DELETE FROM TABLE WHERE ID=1")', tlppCompatible: true },
        { name: 'RecLock', category: 'Banco de Dados', description: 'Trava registro para escrita ou inicia inclusão', syntax: 'RecLock(cAlias, lNew)', parameters: ['cAlias: Tabela', 'lNew: Novo registro?'], returnType: 'Nil', example: 'RecLock("SA1", .F.)\nSA1->A1_NOME := "Teste"\nMsUnlock()', tlppCompatible: true, related: ['MsUnlock'] },
        { name: 'MsUnlock', category: 'Banco de Dados', description: 'Destrava registros da thread atual', syntax: 'MsUnlock()', parameters: [], returnType: 'Nil', example: 'MsUnlock()', tlppCompatible: true },
        { name: 'DbGoTop', category: 'Banco de Dados', description: 'Posiciona no início da tabela (primeiro registro)', syntax: 'DbGoTop()', parameters: [], returnType: 'Nil', example: 'DbGoTop()', tlppCompatible: true },
        { name: 'DbGoBottom', category: 'Banco de Dados', description: 'Posiciona no fim da tabela (último registro)', syntax: 'DbGoBottom()', parameters: [], returnType: 'Nil', example: 'DbGoBottom()', tlppCompatible: true },
        { name: 'DbStruct', category: 'Banco de Dados', description: 'Retorna a estrutura da tabela em array', syntax: 'DbStruct()', parameters: [], returnType: 'Array', example: 'aEstrut := DbStruct() // {{NOME, TIPO, TAM, DEC},...}', tlppCompatible: true },
        { name: 'GetNextAlias', category: 'Banco de Dados', description: 'Gera um alias temporário único', syntax: 'GetNextAlias()', parameters: [], returnType: 'Character', example: 'cAlias := GetNextAlias()', tlppCompatible: true },
        { name: 'RpcSetEnv', category: 'Sistema', description: 'Prepara ambiente Protheus (Empresa/Filial)', syntax: 'RpcSetEnv(cEmp, cFil, cUser, cPass)', parameters: ['cEmp: Empresa', 'cFil: Filial'], returnType: 'Nil', example: 'RpcSetEnv("01", "01")', tlppCompatible: true },
        { name: 'FwMsgRun', category: 'Interface', description: 'Exibe tela de processamento com barra', syntax: 'FwMsgRun(oWnd, bAction, cTitle, cMsg)', parameters: ['bAction: Código a executar'], returnType: 'Nil', example: 'FwMsgRun(,,{|| DoProcess()},"Aguarde","Processando...")', tlppCompatible: true },
        { name: 'At', category: 'String', description: 'Retorna posição da primeira ocorrência de substring', syntax: 'At(cSearch, cTarget)', parameters: ['cSearch: Busca'], returnType: 'Numeric', example: 'nPos := At("@", "user@totvs.com")', tlppCompatible: true },
        { name: 'StrZero', category: 'Conversão', description: 'Converte número para string com zeros à esquerda', syntax: 'StrZero(nVal, nLen)', parameters: ['nVal: Valor', 'nLen: Tamanho final'], returnType: 'Character', example: 'cProtocolo := StrZero(123, 10) // "0000000123"', tlppCompatible: true },
        { name: 'Upper', category: 'String', description: 'Converte string para maiúsculas', syntax: 'Upper(cStr)', parameters: [], returnType: 'Character', example: 'cUpper := Upper("advpl")', tlppCompatible: true },
        { name: 'Lower', category: 'String', description: 'Converte string para minúsculas', syntax: 'Lower(cStr)', parameters: [], returnType: 'Character', example: 'cLower := Lower("ADVPL")', tlppCompatible: true },
        { name: 'Capital', category: 'String', description: 'Primeira letra maiúscula, demais minúsculas', syntax: 'Capital(cStr)', parameters: [], returnType: 'Character', example: 'cName := Capital("MARIA SILVA")', tlppCompatible: true },
        { name: 'Space', category: 'String', description: 'Cria string com N espaços', syntax: 'Space(nLen)', parameters: [], returnType: 'Character', example: 'cVazio := Space(20)', tlppCompatible: true },
        { name: 'Max', category: 'Matemática', description: 'Retorna o maior entre dois números', syntax: 'Max(n1, n2)', parameters: [], returnType: 'Numeric', example: 'nMaior := Max(10, 50) // 50', tlppCompatible: true },
        { name: 'Min', category: 'Matemática', description: 'Retorna o menor entre dois números', syntax: 'Min(n1, n2)', parameters: [], returnType: 'Numeric', example: 'nMenor := Min(10, 50) // 10', tlppCompatible: true },
        { name: 'FCreate', category: 'Arquivos', description: 'Cria um arquivo físico no servidor', syntax: 'FCreate(cFile)', parameters: [], returnType: 'Numeric', example: 'nH := FCreate("log.txt")', tlppCompatible: true },
        { name: 'FOpen', category: 'Arquivos', description: 'Abre um arquivo físico', syntax: 'FOpen(cFile, nMode)', parameters: [], returnType: 'Numeric', example: 'nH := FOpen("dados.txt", 0)', tlppCompatible: true },
        { name: 'FClose', category: 'Arquivos', description: 'Fecha um arquivo aberto por handle', syntax: 'FClose(nH)', parameters: [], returnType: 'Logical', example: 'FClose(nH)', tlppCompatible: true },
        { name: 'FWrite', category: 'Arquivos', description: 'Escreve conteúdo em arquivo', syntax: 'FWrite(nH, cBuffer)', parameters: [], returnType: 'Numeric', example: 'FWrite(nH, "Linha 1")', tlppCompatible: true },
        { name: 'aFill', category: 'Array', description: 'Preenche array com um valor', syntax: 'aFill(aArray, xVal)', parameters: [], returnType: 'Array', example: 'aFill(aDados, 0)', tlppCompatible: true },
        { name: 'aCopy', category: 'Array', description: 'Copia elementos de um array para outro', syntax: 'aCopy(aSrc, aDest)', parameters: [], returnType: 'Array', example: 'aCopy(aOrigem, aDestino)', tlppCompatible: true },
        { name: 'Directory', category: 'Arquivos', description: 'Retorna lista de arquivos de um diretório', syntax: 'Directory(cMask)', parameters: [], returnType: 'Array', example: 'aFiles := Directory("*.png")', tlppCompatible: true },
        { name: 'GetUser', category: 'Sistema', description: 'Retorna o código do usuário logado', syntax: 'GetUser()', parameters: [], returnType: 'Character', example: 'cUser := GetUser()', tlppCompatible: true },
        { name: 'IsAdmin', category: 'Sistema', description: 'Verifica se usuário é administrador', syntax: 'IsAdmin()', parameters: [], returnType: 'Logical', example: 'If IsAdmin() // ...', tlppCompatible: true },
        { name: 'ElapTime', category: 'Data/Hora', description: 'Diferença entre duas strings de tempo', syntax: 'ElapTime(cStart, cEnd)', parameters: [], returnType: 'Character', example: 'cDur := ElapTime("10:00:00", "11:30:00")', tlppCompatible: true },
        { name: 'Seconds', category: 'Data/Hora', description: 'Segundos decorridos desde meia-noite', syntax: 'Seconds()', parameters: [], returnType: 'Numeric', example: 'nSeg := Seconds()', tlppCompatible: true },
        { name: 'Dow', category: 'Data/Hora', description: 'Dia da semana (1=Dom, 7=Sab)', syntax: 'Dow(dDate)', parameters: [], returnType: 'Numeric', example: 'nDia := Dow(Date())', tlppCompatible: true },
        { name: 'MonthSub', category: 'Data/Hora', description: 'Subtrai meses de uma data', syntax: 'MonthSub(dBase, nMonths)', parameters: [], returnType: 'Date', example: 'dAnt := MonthSub(Date(), 1)', tlppCompatible: true },
        { name: 'MesExtenso', category: 'Data/Hora', description: 'Nome do mês por extenso', syntax: 'MesExtenso(dDate)', parameters: [], returnType: 'Character', example: 'cMes := MesExtenso(Date()) // "Fevereiro"', tlppCompatible: true },
        { name: 'DbCreate', category: 'Banco de Dados', description: 'Cria uma nova tabela física', syntax: 'DbCreate(cName, aStruct, cRdd)', parameters: [], returnType: 'Nil', example: 'DbCreate("USERTAB.DTK", aEstrut, "TOPCONN")', tlppCompatible: true },
        { name: 'TVarInfo', category: 'Sistema/Debug', description: 'Exibe informações detalhadas de variável no log', syntax: 'TVarInfo(xVar)', parameters: [], returnType: 'Nil', example: 'TVarInfo(oObjeto)', tlppCompatible: true },
        // Novos Batches de Funções (41-80)
        { name: 'TCheckBox', category: 'Interface', description: 'Cria um componente checkbox', syntax: 'TCheckBox():New(nTop, nLeft, cCaption, bSetGet, oWnd)', parameters: ['cCaption: Label', 'bSetGet: Bloco da variável'], returnType: 'Object', example: 'oCheck := TCheckBox():New(10,10,"Ativo",{|u| if(u==nil,lAtivo,lAtivo:=u)},oDlg)', tlppCompatible: true },
        { name: 'TRadioButtons', category: 'Interface', description: 'Cria grupo de botões de rádio', syntax: 'TRadioButtons():New(nTop, nLeft, bSetGet, aItems, oWnd)', parameters: ['aItems: Array de opções'], returnType: 'Object', example: 'oRadio := TRadioButtons():New(10,10,{|u| u}, {"Op1", "Op2"}, oDlg)', tlppCompatible: true },
        { name: 'TComboBox', category: 'Interface', description: 'Cria componente de lista suspensa', syntax: 'TComboBox():New(nTop, nLeft, bSetGet, aItems, nWidth, nHeight, oWnd)', parameters: ['aItems: Itens do combo'], returnType: 'Object', example: 'oCombo := TComboBox():New(10,10,{|u| u}, {"A", "B"}, 50, 20, oDlg)', tlppCompatible: true },
        { name: 'TListBox', category: 'Interface', description: 'Cria componente de lista simples', syntax: 'TListBox():New(nTop, nLeft, bSetGet, aItems, nWidth, nHeight, oWnd)', parameters: [], returnType: 'Object', example: 'oList := TListBox():New(10,10,{|u| u}, aItens, 100, 100, oDlg)', tlppCompatible: true },
        { name: 'TBitmap', category: 'Interface', description: 'Exibe imagem na interface', syntax: 'TBitmap():New(nTop, nLeft, nWidth, nHeight, cRes, cFile, lPixel, oWnd)', parameters: ['cFile: Caminho da imagem'], returnType: 'Object', example: 'oBit := TBitmap():New(0,0,100,100,,"logo.bmp",.T.,oDlg)', tlppCompatible: true },
        { name: 'TBrowse', category: 'Interface', description: 'Cria objeto de navegação em tabelas/arrays', syntax: 'TBrowse():New(nTop, nLeft, nBottom, nRight, oWnd)', parameters: [], returnType: 'Object', example: 'oBrw := TBrowse():New(0,0,200,400,oDlg)', tlppCompatible: true },
        { name: 'FwWaitCursor', category: 'Interface', description: 'Exibe ou remove o cursor de espera (ampulheta)', syntax: 'FwWaitCursor(lShow)', parameters: ['lShow: Ativar?'], returnType: 'Nil', example: 'FwWaitCursor(.T.)\n// Processamento\nFwWaitCursor(.F.)', tlppCompatible: true },
        { name: 'DbSelectArea', category: 'Banco de Dados', description: 'Seleciona área de trabalho/alias', syntax: 'DbSelectArea(cAlias)', parameters: [], returnType: 'Nil', example: 'DbSelectArea("SB1")', tlppCompatible: true },
        { name: 'DbSetOrder', category: 'Banco de Dados', description: 'Ativa índice pela ordem', syntax: 'DbSetOrder(nOrder)', parameters: [], returnType: 'Nil', example: 'DbSetOrder(2)', tlppCompatible: true },
        { name: 'IndexOrd', category: 'Banco de Dados', description: 'Retorna o número da ordem de índice atual', syntax: 'IndexOrd()', parameters: [], returnType: 'Numeric', example: 'nOrdem := IndexOrd()', tlppCompatible: true },
        { name: 'Used', category: 'Banco de Dados', description: 'Verifica se alias está aberto na thread', syntax: 'Used()', parameters: [], returnType: 'Logical', example: 'If Used() // ...', tlppCompatible: true },
        { name: 'Select', category: 'Banco de Dados', description: 'Retorna o número da área de trabalho do alias', syntax: 'Select(cAlias)', parameters: [], returnType: 'Numeric', example: 'nArea := Select("SA1")', tlppCompatible: true },
        { name: 'Mod', category: 'Matemática', description: 'Retorna o resto da divisão', syntax: 'Mod(n1, n2)', parameters: [], returnType: 'Numeric', example: 'nResto := Mod(10, 3) // 1', tlppCompatible: true },
        { name: 'Sqrt', category: 'Matemática', description: 'Raiz quadrada', syntax: 'Sqrt(nValue)', parameters: [], returnType: 'Numeric', example: 'nRaiz := Sqrt(81) // 9', tlppCompatible: true },
        { name: 'Exp', category: 'Matemática', description: 'Exponencial (e elevado a X)', syntax: 'Exp(nValue)', parameters: [], returnType: 'Numeric', example: 'nExp := Exp(1)', tlppCompatible: true },
        { name: 'Log', category: 'Matemática', description: 'Logaritmo natural', syntax: 'Log(nValue)', parameters: [], returnType: 'Numeric', example: 'nLog := Log(10)', tlppCompatible: true },
        { name: 'RAt', category: 'String', description: 'Posição da última ocorrência de substring', syntax: 'RAt(cSearch, cTarget)', parameters: [], returnType: 'Numeric', example: 'nPos := RAt(".", "arquivo.txt.old")', tlppCompatible: true },
        { name: 'aIns', category: 'Array', description: 'Insere elemento no array (desloca outros)', syntax: 'aIns(aArray, nPos)', parameters: [], returnType: 'Array', example: 'aIns(aLista, 1)', tlppCompatible: true },
        { name: 'aTail', category: 'Array', description: 'Retorna último elemento do array', syntax: 'aTail(aArray)', parameters: [], returnType: 'Any', example: 'xUltimo := aTail(aDados)', tlppCompatible: true },
        { name: 'Bin2I', category: 'Conversão', description: 'Converte binário assinado de 2 bytes para inteiro', syntax: 'Bin2I(cIn)', parameters: [], returnType: 'Numeric', example: 'nVal := Bin2I(cBinary)', tlppCompatible: true },
        { name: 'I2Bin', category: 'Conversão', description: 'Converte inteiro para binário de 2 bytes', syntax: 'I2Bin(nIn)', parameters: [], returnType: 'Character', example: 'cBin := I2Bin(100)', tlppCompatible: true },
        { name: 'DecToHex', category: 'Conversão', description: 'Converte decimal para hexadecimal', syntax: 'DecToHex(nVal)', parameters: [], returnType: 'Character', example: 'cHex := DecToHex(255) // "FF"', tlppCompatible: true },
        { name: 'HexToDec', category: 'Conversão', description: 'Converte hexadecimal para decimal', syntax: 'HexToDec(cHex)', parameters: [], returnType: 'Numeric', example: 'nDec := HexToDec("FF") // 255', tlppCompatible: true },
        { name: 'CurDir', category: 'Arquivos', description: 'Retorna diretório corrente do servidor', syntax: 'CurDir()', parameters: [], returnType: 'Character', example: 'cPath := CurDir()', tlppCompatible: true },
        { name: 'GetServerType', category: 'Sistema', description: 'Retorna tipo do servidor (Protheus, Lobo-Guará)', syntax: 'GetServerType()', parameters: [], returnType: 'Character', example: 'cType := GetServerType()', tlppCompatible: true },
        { name: 'GetSrvProfString', category: 'Sistema', description: 'Lê chave do arquivo .ini do servidor', syntax: 'GetSrvProfString(cSection, cKey, cDefault)', parameters: [], returnType: 'Character', example: 'cPort := GetSrvProfString("TCP", "Port", "1234")', tlppCompatible: true },
        { name: 'WritePProString', category: 'Sistema', description: 'Escreve no arquivo de perfil (ini)', syntax: 'WritePProString(cSec, cKey, cVal, cFile)', parameters: [], returnType: 'Logical', example: 'WritePProString("USER", "Last", "1", "config.ini")', tlppCompatible: true },
        { name: 'RpcClearEnv', category: 'Sistema', description: 'Finaliza ambiente RPC', syntax: 'RpcClearEnv()', parameters: [], returnType: 'Nil', example: 'RpcClearEnv()', tlppCompatible: true },
        { name: 'GetRemoteType', category: 'Sistema', description: 'Retorna ID do tipo de conexão remota', syntax: 'GetRemoteType()', parameters: [], returnType: 'Numeric', example: 'nType := GetRemoteType() // 1=TC, 2=Telnet...', tlppCompatible: true },
        { name: 'IsSrvUnix', category: 'Sistema', description: 'Se o server é Linux/Unix', syntax: 'IsSrvUnix()', parameters: [], returnType: 'Logical', example: 'If IsSrvUnix() // ...', tlppCompatible: true },
        { name: 'IsSrvWindows', category: 'Sistema', description: 'Se o server é Windows', syntax: 'IsSrvWindows()', parameters: [], returnType: 'Logical', example: 'If IsSrvWindows() // ...', tlppCompatible: true },
        { name: 'Day', category: 'Data/Hora', description: 'Retorna o dia do mês', syntax: 'Day(dDate)', parameters: [], returnType: 'Numeric', example: 'nDia := Day(Date())', tlppCompatible: true },
        { name: 'DaySub', category: 'Data/Hora', description: 'Subtrai dias de uma data', syntax: 'DaySub(dBase, nDays)', parameters: [], returnType: 'Date', example: 'dOntem := DaySub(Date(), 1)', tlppCompatible: true },
        { name: 'GetComputerName', category: 'Sistema', description: 'Nome do computador (Host)', syntax: 'GetComputerName()', parameters: [], returnType: 'Character', example: 'cHost := GetComputerName()', tlppCompatible: true },
        { name: 'MsEraseLogin', category: 'Segurança', description: 'Limpa informações de login da thread', syntax: 'MsEraseLogin()', parameters: [], returnType: 'Nil', example: 'MsEraseLogin()', tlppCompatible: true },
        { name: 'TMSPrinter', category: 'Relatórios', description: 'Objeto avançado de impressão Protheus', syntax: 'TMSPrinter():New(cJobName)', parameters: [], returnType: 'Object', example: 'oPrint := TMSPrinter():New("Relat")', tlppCompatible: true },
